  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-2">
        ...
        {hasSignature && (
          <button
            type="button"
            onClick={clearCanvas}
            className="font-sans text-[11px] tracking-wider text-charcoal-light hover:text-gold transition-colors"
          >
            Clear
          </button>
        )}
      ...
      <canvas
        ...
        onTouchEnd={endDraw}
      />
      <p className="mt-1 font-sans text-[11px] tracking-wider text-charcoal-light/70">
...
export function InquiryForm() {
  ...
  const labelStyles =
    "font-sans text-[11px] tracking-[0.2em] uppercase text-charcoal";
