    ...
    <>
      ...
      <Section background="charcoal">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-md font-sans text-sm leading-relaxed text-cream/80 tracking-wider">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button href="/packages" variant="outline" className="border-cream/40 text-cream hover:bg-gold hover:text-charcoal hover:border-gold">
              View Packages
            </Button>
          </div>
        </div>
